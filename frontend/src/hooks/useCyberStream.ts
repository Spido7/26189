  ...
  const injectManualPacket = useCallback(() => {
    ...
    const manualPacket: CyberPacketTemplate = {
      ...
      personalInfo: {
        ...
        fullName: "Injected Threat Entity",
        demography: { text: "Simulated Threat Injection", location: "Unknown" },
        contactDetails: { phone: "+91 98000 XXXXX", email: "threat@isolated.net" },
        occupation: "Adversarial Test Injection",
      },
      firDetails: {
        firId: "FIR-TEST-9999",
        firDate: new Date().toISOString(),
        policeStation: "Cyber Forensics Testing Lab",
        crpcSection: "Section 66 IT Act",
        statusOfCharges: "Test Simulation Probe",
        firCopy: {
          documentNumber: "E-FIR-TEST-9999",
          filingOfficer: "System Autonomous Ingestion",
          ledgerHash: "SHA256:00000000000000000000000000000000",
          summaryText: "Test injected packet for pipeline verification.",
          certifiedSeal: "TEST SEAL",
        },
      },
      cdrDetails: {
        callerIdNumber: "INJECT-TEST",
        receiverIdNumber: "SYS-CORE",
        callTypeAndDuration: "Synthetic Packet Ingress",
        towerLocation: "Local Sandbox Core",
      },
    };
